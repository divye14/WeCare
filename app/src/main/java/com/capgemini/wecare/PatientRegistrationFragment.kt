...
class PatientRegistrationFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val registerB = view.findViewById<Button>(R.id.patientRegisterB)

        registerB.setOnClickListener {
            // navigate user to Authentication page

            findNavController().navigate(R.id.action_patientRegistrationFragment_to_authenticationFragment)
        }
    }
    ...
    companion object {
        ...
        fun newInstance(param1: String, param2: String) =
            PatientRegistrationFragment().apply {
